...
^             : keyword.operator.negation.regexp, meta.character.set.regexp, source.regexp.python
]             : constant.character.set.regexp, meta.character.set.regexp, source.regexp.python
