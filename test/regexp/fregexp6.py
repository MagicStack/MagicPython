...
{{            : constant.character.escape.python, source.python, string.regexp.quoted.single.python
{2}           : source.python, string.regexp.quoted.single.python
}}            : constant.character.escape.python, source.python, string.regexp.quoted.single.python
...
fo            : source.python, string.regexp.quoted.single.python
{{            : constant.character.escape.python, source.python, string.regexp.quoted.single.python
{bar}         : source.python, string.regexp.quoted.single.python
}}            : constant.character.escape.python, source.python, string.regexp.quoted.single.python
'             : punctuation.definition.string.end.python, source.python, string.regexp.quoted.single.python
a             : source.python
              : source.python
