...
bad           : source.python, string.quoted.single.binary.python
\\            : constant.character.python, source.python, string.quoted.single.binary.python
 string       : source.python, string.quoted.single.binary.python
              : invalid.illegal.newline.python, source.python, string.quoted.single.binary.python
foo           : source.python
