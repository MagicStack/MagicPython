...
\             : constant.language.python, source.python, string.quoted.multi.python
              ...
              : source.python, string.quoted.multi.python
\xf1          : constant.character.python, source.python, string.quoted.multi.python
              : source.python, string.quoted.multi.python
\u1234        : constant.character.python, source.python, string.quoted.multi.python
aaaa          : source.python, string.quoted.multi.python
\U1234aaaa    : constant.character.python, source.python, string.quoted.multi.python
              : source.python, string.quoted.multi.python
              : source.python, string.quoted.multi.python
\N{BLACK SPADE SUIT} : constant.character.python, source.python, string.quoted.multi.python
