...
{             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.single.python
}             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.single.python
              : source.python, string.regexp.quoted.single.python
{             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.single.python
              : invalid.illegal.brace.python, source.python, string.regexp.quoted.single.python
}             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.single.python
...
{             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.multi.python
}             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.multi.python
{             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.multi.python
              : invalid.illegal.brace.python, source.python, string.regexp.quoted.multi.python
}             : constant.character.format.placeholder.other.python, source.python, string.regexp.quoted.multi.python
