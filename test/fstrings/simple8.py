...
abc           : meta.fstring.python, source.python, string.quoted.single.python
\             : meta.fstring.python, source.python, string.quoted.single.python
 ...
 efg          : meta.fstring.python, source.python, string.quoted.single.python
